        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <Link className="transition-all duration-300 hover:translate-x-2 hover:text-lime-300" to="/">
                  Home
                </Link>
              </li>

              <li>
                <Link className="transition-all duration-300 hover:translate-x-2 hover:text-lime-300" to="/equipment">
                  Equipment
                </Link>
              </li>

              <li>
                <Link className="transition-all duration-300 hover:translate-x-2 hover:text-lime-300" to="/categories">
                  Categories
                </Link>
              </li>

              <li>
                <Link className="transition-all duration-300 hover:translate-x-2 hover:text-lime-300" to="/about">
                  About
                </Link>
              </li>

              <li>
                <Link className="transition-all duration-300 hover:translate-x-2 hover:text-lime-300" to="/contact">
                  Contact
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-4 text-emerald-100">
              ...
              <li className="transition-all duration-300 hover:translate-x-2 hover:text-lime-300">
                Tool Rental
              </li>
